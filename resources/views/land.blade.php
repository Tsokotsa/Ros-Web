...
<html lang="en" data-style-switcher-options="{'showBordersStyle': true, 'showLayoutStyle': false, 'showBackgroundColor': false, 'borderRadius': '0', 'changeLogo': false, 'colorPrimary': '#E04622', 'colorSecondary': '#EEAB26', 'colorTertiary': '#EAEFF3', 'colorQuaternary': '#080808'}">
	<head>
		...
		<title>ROS | Results Oriented Services</title>	
		...
		<!-- Demo CSS -->		<link rel="stylesheet" href="{{ url('assets/css/main.css') }}" >

		<!-- Skin CSS -->		<link id="skinCSS" rel="stylesheet" href="{{ url('assets/css/skin.css') }}">
	...
	<body data-plugin-scroll-spy data-plugin-options="{'target': '#sidebar'}">
		...
		<div class="body">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo custom-header-logo">
										<img class="logo" alt="Porto" width="123" height="48" src="assets/media/construction/ros-croped.png">
										<a href="demo-construction.html">
											<img class="logo-sticky" alt="Porto" width="123" height="48" src="assets/media/construction/ros-croped.png">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="owl-item position-relative">
								...
								<div class="container position-relative z-index-1 h-100">
									...
									<div class="position-absolute left-100pct bottom-0 transform3dx-n50 w-75 ms-5">
										<img src="{{ url('assets/media/construction/slides/desta.png') }}" class="img-fluid mw-100 w-auto appear-animation" alt="Engineer Image" data-appear-animation="fadeIn" data-appear-animation-delay="100" />
									</div>
				...
				<div class="container py-5 my-3">
					<div class="row justify-content-between align-items-center flex-lg-nowrap gy-3">
						<div class="col-lg-4">
							...
							<p class="text-4 font-weight-light mb-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="2200">We truly belive that excellence shouldnt come with a cost. Results is what drives us. </p>
						</div>
								...
								<div class="card border-0">
									...
									<div class="card-body py-4 px-0">
										...
										<span class="custom-view-more d-inline-flex font-weight-medium text-color-primary">
											View More
											<img width="27" height="27" src="assets/media/construction/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" style="width: 27px;" />
										</span>
									</div>
								</div>
							</a>
			...
			<footer id="footer" class="overflow-hidden border-0 m-0" style="background-image: url(assets/media/construction/backgrounds/background-2.jpg); background-repeat: no-repeat; background-position: center bottom;">
				<div class="container pt-5">
					<div class="row pt-4 mb-5 gy-4">
						<div class="col-lg-2 align-self-center">
							<a href="demo-construction.html">
								<img alt="Porto" class="img-fluid logo" width="123" height="48" src="assets/media/construction/ros-croped.png">
							</a>
						</div>
						...
						<div class="col-lg-5">
							...
							<ul class="list list-unstyled list-inline">
								<li class="list-inline-item d-inline-flex align-items-center">
									<img width="23" height="23" src="assets/media/construction/icons/phone.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-dark'}" />
									<a href="tel:843892378" class="text-decoration-none text-color-dark text-color-hover-primary font-weight-bold text-3-5 ms-2">(84) 389-2378</a>
								</li>
								<li class="list-inline-item d-inline-flex align-items-center ms-0 ms-sm-4 ms-lg-1 ms-xl-4">
									<img width="23" height="23" src="assets/media/construction/icons/email.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-dark'}" />
									<a href="/cdn-cgi/l/email-protection#2919181b1a1d1c1f1e1110" class="text-decoration-none text-color-dark text-color-hover-primary font-weight-bold text-3-5 ms-2"><span class="__cf_email__" data-cfemail="f989968b8d96b99a96978a8d8b8c9a8d909697d79a9694">results.lda@gmail.com</span></a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="footer-copyright bg-transparent pb-5 mt-5-5">
						<div class="row pb-5">
							<div class="col text-center mb-5">
								<p class="text-color-grey text-3 mb-3">ROS © 2024. All Rights Reserved by Tsk. </p>
								<ul class="footer-social-icons social-icons social-icons-clean social-icons-medium mb-5">
									...
									<li class="social-icons-twitter">
										<a href="http://www.twitter.com/" target="_blank" title="Twitter"><i class="fab fa-x-twitter text-4"></i></a>
									</li>
...
-->
		<!-- Vendor -->		<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{ url('assets/vendor/plugins/js/plugins.min.js') }}"></script>
